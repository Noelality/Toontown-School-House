...
SuitFlunky = '5 Inch Wonder'
SuitPencilPusher = 'No. 2'
SuitYesman = 'Glad Guy'
...
SuitColdCaller = 'Frozone'
SuitTelemarketer = 'Sad Guy'
SuitNameDropper = 'Angry Karen'
...
SuitShortChange = 'MoneyMan'
SuitPennyPincher = 'Mad Guy'
SuitTightwad = 'Greed Guy'
...
SuitBottomFeeder = 'PurpleRock'
SuitBloodsucker = 'Vampire'
SuitDoubleTalker = 'Rhyno Guy'
...
AvatarChooserPickAToon = 'Pick  The  Funny!'
